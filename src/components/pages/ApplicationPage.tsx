...
import { 
  ...
  BookOpen, Users, Target, Award, Calendar, Clock, 
  DollarSign, Mail, Phone, User, Heart, Cpu, Scale
} from 'lucide-react';
...
const PROGRAMS = [
  {
    ...
    batches: [
      { id: 'foundation', name: 'Tech Buds', class: '6-8', fee: '₹15,000' },
      { id: 'explorer', name: 'Tech Explorers', class: '9-10', fee: '₹18,000' },
      { id: 'achiever', name: 'Engineering Excellence', class: '11-12', fee: '₹20,000' }
    ]
  },
  {
    id: 'medical',
    ...
    batches: [
      { id: 'foundation', name: 'Little Healers', class: '6-8', fee: '₹15,000' },
      { id: 'explorer', name: 'Medical Explorers', class: '9-10', fee: '₹18,000' },
      { id: 'achiever', name: 'Medical Excellence', class: '11-12', fee: '₹20,000' }
    ]
  },
  {
    id: 'civil',
    ...
    batches: [
      { id: 'foundation', name: 'Young Leaders', class: '6-8', fee: '₹15,000' },
      { id: 'explorer', name: 'Civil Explorers', class: '9-10', fee: '₹18,000' },
      { id: 'achiever', name: 'Civil Excellence', class: '11-12', fee: '₹20,000' }
    ]
  }
];
...
export default function ApplicationPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      {/* Header */}
      <div className="pt-32 pb-8 px-6 lg:px-12 bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto">
          <h1 className="font-heading text-4xl font-bold text-textprimary mb-2">
            Apply for Admission
          </h1>
                ...
                <div key={step.id} className="flex flex-col items-center">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold
                    ${currentStep > step.id 
                      ...
                      : currentStep === step.id
                      ? 'bg-[#B8860B] text-white ring-4 ring-[#B8860B]/20'
            ...
            >
              ...
              {currentStep === 1 && (
                <div>
                      ...
                      return (
                        <div
                          ...
                          className={`relative p-6 rounded-xl border-2 cursor-pointer transition-all
                            ${isSelected 
                              ? `${program.borderColor} ${program.lightBg} shadow-md` 
                        ...
                        >
                          ...
                          <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${program.gradient} flex items-center justify-center text-2xl mb-4`}>
                            {program.icon}
                          </div>
                          <h3 className="font-heading text-lg font-bold text-textprimary mb-2">
                            {program.name}
                          </h3>
                          <p className="text-sm text-textprimary/60">
                            3 batches • {program.batches.length} options
                          </p>
                        </div>
                      );
                    })}
                  ...
                  {errors.program && (
                    <p className="mt-4 text-sm text-red-500">{errors.program}</p>
                  )}
                </div>
              )}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#B8860B]/50 focus:border-[#B8860B]"
              ...
              {currentStep === 4 && selectedProgram && (
                <div>
                    ...
                    {selectedProgram.batches.map((batch) => {
                      ...
                      return (
                        <div
                          ...
                          className={`relative p-6 rounded-xl border-2 cursor-pointer transition-all
                            ${isSelected 
                              ? `${selectedProgram.borderColor} ${selectedProgram.lightBg} shadow-md` 
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2 text-sm text-textprimary/60 mb-3">
                            <Calendar size={14} /> 12 Months
                            <Clock size={14} className="ml-2" /> Weekends
                          </div>
                          <p className="font-heading text-xl font-bold text-[#B8860B]">
                            {batch.fee}/year
                          </p>
                        </div>
                      );
                  ...
                  {errors.batch && (
                    <p className="mt-4 text-sm text-red-500">{errors.batch}</p>
                  )}
                </div>
              )}
              ...
              {currentStep === 5 && selectedProgram && selectedBatch && (
                <div>
                  ...
                  <div className="space-y-6">
                    {/* Program Summary */}
                    <div className={`p-6 rounded-xl ${selectedProgram.lightBg} border ${selectedProgram.borderColor}`}>
                      <h3 className="font-heading text-lg font-bold text-textprimary mb-4">
                        Program Details
                      </h3>
                      <div className="flex items-center gap-4">
                        <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${selectedProgram.gradient} flex items-center justify-center text-2xl`}>
                    ...
                    <div className="p-6 bg-gray-50 rounded-xl">
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                          <p className="text-textprimary/60">Relation</p>
                    ...
                    <div className="p-6 bg-gray-50 rounded-xl">
                      ...
                      <div className="flex justify-between items-center">
                        <div>
                          <p className="text-textprimary/60">Total Fee (Annual)</p>
                          <p className="font-heading text-2xl font-bold text-[#B8860B]">{selectedBatch.fee}</p>
                        </div>
                        <div className="text-right">
                          <p className="text-textprimary/60">Payment Plan</p>
              ...
              <div className="flex justify-between mt-8 pt-6 border-t border-gray-200">
                <button
                  onClick={handleBack}
                  className="px-6 py-3 border border-gray-300 text-textprimary rounded-lg hover:bg-gray-50 transition-colors flex items-center gap-2"
                >
                  <ArrowLeft size={16} />
                  Back
                </button>
                <button
                  onClick={handleNext}
                  className="px-8 py-3 bg-[#B8860B] text-white rounded-lg hover:bg-[#D4AF37] transition-colors flex items-center gap-2 font-semibold"
                >
