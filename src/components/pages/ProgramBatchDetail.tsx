...
const BATCH_DETAILS = {
  ...
  engineering: {
    foundation: {
      ...
      testimonials: [
        { quote: "My son used to spend hours on games, now he builds them! This program sparked his interest in technology.", author: "Mrs. Sharma", relation: "Parent of Aarav, Class 7" },
        { quote: "The way they teach coding through stories and games is amazing. My daughter loves her Saturday classes!", author: "Mr. Patel", relation: "Parent of Kiara, Class 6" }
      ]
    },
  ...
  medical: {
    foundation: {
      ...
      description: 'Introduction to the human body, health, and the medical profession through fun activities and stories.',
      
      longDescription: 'Dream Foundation - Little Healers introduces young learners to the fascinating world of medicine. Through interactive activities, models, and stories, children learn about the human body, health, and the role of doctors in society.',
      ...
      careerRoles: [
        { title: 'Junior Body Explorer', description: 'Human body basics, organs', icon: Heart, color: 'text-red-500' },
        { title: 'Junior Health Hero', description: 'Health, hygiene, nutrition', icon: Activity, color: 'text-green-500' },
        { title: 'Junior Life Saver', description: 'First aid, emergency awareness', icon: Shield, color: 'text-blue-500' },
        { title: 'Junior Bio Explorer', description: 'Cells, plants, animals', icon: Brain, color: 'text-purple-500' },
        { title: 'Junior Medical Scientist', description: 'Simple experiments, lab fun', icon: Cpu, color: 'text-yellow-500' },
        { title: 'Junior Doctor Buddy', description: 'Doctor roles & hospitals', icon: Users, color: 'text-indigo-500' }
      ],
      ...
      outcomes: [
        ...
        '👨‍⚕️ Understanding of doctor\'s role'
      ],
    ...
    explorer: {
      ...
      description: 'Explore various medical careers and understand the path to becoming a doctor or healthcare professional.',
      
      longDescription: 'Dream Explorer - Medical Explorers helps students discover their true passion in the medical field. Through career exploration modules, hands-on activities, and mentorship from practicing doctors, students gain clarity about their future in medicine.',
      ...
      outcomes: [
        ...
        '👨‍⚕️ Career clarity about medical path'
      ],
    ...
    achiever: {
      ...
      description: 'Comprehensive preparation for MBBS and other medical entrance exams with specialization guidance.',
      
      longDescription: 'Dream Achiever - Medical Excellence Program provides comprehensive preparation for medical entrance exams while giving students clarity about their specialization path. With mentorship from practicing doctors and medical educators, students get a clear roadmap to their dream medical career.',
      ...
      outcomes: [
        ...
        '👨‍⚕️ Guidance from practicing doctors'
      ],
  ...
  civil: {
    foundation: {
      ...
      description: 'Introduction to India, society, and leadership through stories and activities.',
      
      longDescription: 'Dream Foundation - Young Leaders introduces students to the concepts of nation-building, leadership, and public service. Through stories of great leaders, interactive activities, and discussions, children develop values of responsibility, integrity, and service.',
    ...
    explorer: {
      ...
      description: 'Explore various civil services and understand the path to becoming an IAS/IPS officer.',
      
      longDescription: 'Dream Explorer - Civil Services Explorers helps students understand the various civil services and the path to join them. Through subject exposure, current affairs discussions, and mentorship from serving officers, students gain clarity about their future in public service.',
      ...
      outcomes: [
        ...
        '⚖️ Career clarity about civil services'
      ],
    ...
    achiever: {
      ...
      description: 'Advanced preparation for UPSC and other civil services exams with focus on answer writing and personality development.',
      
      longDescription: 'Dream Achiever - Civil Services Excellence Program provides comprehensive preparation for the UPSC examination. Students develop deep understanding of core subjects, practice answer writing, and receive mentorship from former civil servants. This program gives students a head start in their UPSC journey.',
...
export default function ProgramBatchDetail() {
  ...
  useEffect(() => {
    ...
    if (programId && batchType && BATCH_DETAILS[programId as keyof typeof BATCH_DETAILS]) {
      ...
      const data = program[batchType as keyof typeof program];
      console.log('Found batch data:', data);
      setBatchData(data);
    } else {
      console.log('No data found for:', programId, batchType);
    }
    window.scrollTo(0, 0);
  }, [programId, batchType]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      {/* Main Content - Rest of your code remains same */}
